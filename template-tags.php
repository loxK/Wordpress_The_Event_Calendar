...
if( class_exists( 'The_Events_Calendar' ) && !function_exists( 'eventsGetOptionValue' ) ) {
	...
	*/
	 ...
	 * @return string 
	 */
	function events_get_link() {
	    global $spEvents;
		
		if( $page_id = $spEvents->eventPageId() ) $link = get_permalink( $page_id );
		else {
